export const categories = [
  ...
  { key: 'eat', label: '食べる', icon: '🍜', description: 'そば、食事処、カフェ、酒蔵' },
  { key: 'shop', label: '買う', icon: '🛍', description: '特産品、おみやげ、地元のお店' },
...
export const spots = [
  ...
  { id:'horiguchi', name:'堀口酒造（鳴り瓢）', category:'eat', subcategory:'酒蔵', tags:['日本酒','酒蔵','徒歩圏'] },
  { id:'kitazen', name:'北善商店', category:'eat', subcategory:'酒蔵', tags:['日本酒','酒蔵','徒歩圏'] },
  { id:'hatakeyama', name:'畠山酒造', category:'eat', subcategory:'酒蔵', tags:['日本酒','酒蔵','徒歩圏'] },
  { id:'shirakoma', name:'白駒酒造', category:'eat', subcategory:'酒蔵・歴史', tags:['酒蔵跡','歴史','徒歩圏'] },
